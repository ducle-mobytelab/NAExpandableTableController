...
<<<<<<< HEAD
    let expandableSectionIndices = [0, 5, 3]
=======
    let expandableSectionIndices = [0, 2, 3]
>>>>>>> parent of 3c4dc36... Update expandableSectionIndices
    ...
    func expandableTableView(_ tableView: UITableView, cellForRowAtIndexPath indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure cell here...
        cell.textLabel?.text = "Cell - section \((indexPath as NSIndexPath).section), row \((indexPath as NSIndexPath).row)"
        return cell
    }
    ...
    func expandableTableView(_ tableView: UITableView, didSelectRowAtIndexPath indexPath: IndexPath) {
        print("Cell selected - section \((indexPath as NSIndexPath).section), row \((indexPath as NSIndexPath).row)")
    }
